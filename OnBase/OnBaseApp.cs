...
{    
    ...
    public override bool IsConnected => _session.IsActive;
    public override IHylandClientFactory ClientFactory => _clientFactory;
    public override IHylandClientOptions ClientOptions => _options;
